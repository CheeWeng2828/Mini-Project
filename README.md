...
# 🛠️ Tech Stack
- Language/Framework: [C# (ASP.NET), Frontend(HTML,CSS,JavaScript)]
- Database: [MySQL]
- Prerequisites: 
    - Visual Studio 2022
    - Entity Framework Core (SQL Server, Tools)
    - QRCoder
    - ImageSharp
...
```
# CTRL+F5 to start project
# Click "Yes" when the warning message prompt up (above 4 times)
